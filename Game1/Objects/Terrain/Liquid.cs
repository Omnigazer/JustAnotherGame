...
namespace Omniplatformer.Objects.Terrain
{
    public class Liquid : GameObject
    {
        ...
        {
            RegisterComponent(new PhysicsComponent() { Liquid = true, Solid = false, Friction = 0.1f });
            RegisterComponent(new LiquidRenderComponent(Color.Aqua * 0.5f, z_index: Layers.Liquid));
        }
