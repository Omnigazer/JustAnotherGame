...
namespace Omniplatformer.HUD
{
    ...
    {
        public ChaosManaBar(Point position, int width, int height) : base(position, width, height)
        {
        }

        public override void Draw()
        {
            if (Player.MaxMana(ManaType.Chaos) > 0)
            {
                ...
                Point current_size = new Point((int)((Width - Thickness * 2) * (Player.CurrentMana[ManaType.Chaos] / Player.MaxMana(ManaType.Chaos))),
                    Height - Thickness * 2);
                ...
                spriteBatch.Draw(GameContent.Instance.testLiquid, inner_rect, source_rect, Color.FromNonPremultiplied(255, 80, 20, 255));
                ...
                //spriteBatch.Draw(GameContent.Instance.causticsMap, inner_rect, source_rect, Color.Orange);
                spriteBatch.End();
                base.Draw();
            }
        }
