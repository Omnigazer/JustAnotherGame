...
namespace Omniplatformer.Graphics
{
    public class TileBuffer
    {
        ...
        // Tex meta
        private int AtlasWidth => GameContent.Instance.atlas.Width;

        private int AtlasHeight => GameContent.Instance.atlas.Height;
        ...
        public TileBuffer(int tile_count)
        {
        ...
        public void AddTile(int i, int j, short type)
        {
